...
namespace BackendCore.Data.Migrations
{
    ...
    [Migration("20221227115938_UpdateEntitiesRemoveDeviceBrand")]
    partial class UpdateEntitiesRemoveDeviceBrand
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackendCore.Entities.Entities.Identity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Admin",
                            PasswordHash = "AI8Cop9S3ZFWnckqhrAj6QVLJEK+yQb6/wWWPKhtISMriXufHdXDL/prC8OOcEqAwA==",
                            Phone = "01016670280",
                            UserName = "admin"
                        });
                });
            ...
            modelBuilder.Entity("BrandDevice", b =>
                {
                    ...
                    b.HasKey("BrandsId", "DevicesId");

                    b.HasIndex("DevicesId");

                    b.ToTable("BrandDevice");
                });
            ...
            modelBuilder.Entity("BrandDevice", b =>
                {
                    b.HasOne("BackendCore.Entities.Entities.Business.Brand", null)
                        .WithMany()
                        .HasForeignKey("BrandsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BackendCore.Entities.Entities.Business.Device", null)
                        .WithMany()
