...
namespace BackendCore.Data.Migrations
{
    ...
    [Migration("20230108122849_UpdatePropertiesDatatypes")]
    partial class UpdatePropertiesDatatypes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackendCore.Entities.Entities.Business.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BackendCore.Entities.Entities.Identity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Admin",
                            PasswordHash = "AKTzjXdkjwfV7898SM5qPSf0frHItyH2Nn9eGnQuKJkEMB5iAufx+h3e6Y8SdnvTVg==",
                            Phone = "01016670280",
                            UserName = "admin"
                        });
                });
            ...
            modelBuilder.Entity("BackendCore.Entities.Entities.Business.Device", b =>
                {
                    b.HasOne("BackendCore.Entities.Entities.Business.Department", "Department")
                        .WithMany("Devices")
            ...
            modelBuilder.Entity("BackendCore.Entities.Entities.Business.ModelDetail", b =>
                {
                    b.HasOne("BackendCore.Entities.Entities.Business.DeviceBrand", "DeviceBrand")
