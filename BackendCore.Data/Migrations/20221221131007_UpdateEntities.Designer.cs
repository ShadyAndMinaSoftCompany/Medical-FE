...
namespace BackendCore.Data.Migrations
{
    ...
    [Migration("20221221131007_UpdateEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackendCore.Entities.Entities.Business.DepartmentDevice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BackendCore.Entities.Entities.Identity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Admin",
                            PasswordHash = "AKJy82/niO2UlFFbutj/7hhPneOMwhsQyfHyKDv5Eslbuudlyn8notvAkGd3neG5yg==",
                            Phone = "01016670280",
                            UserName = "admin"
                        });
                });
            ...
            modelBuilder.Entity("BackendCore.Entities.Entities.Lookup.Device", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BackendCore.Entities.Entities.Business.DepartmentDevice", b =>
                {
                    b.HasOne("BackendCore.Entities.Entities.Lookup.Department", "Department")
                        .WithMany("DepartmentDevices")
                        .HasForeignKey("DepartmentId");

                    b.HasOne("BackendCore.Entities.Entities.Lookup.Device", "Device")
                        .WithMany("DepartmentDevices")
            ...
            modelBuilder.Entity("BackendCore.Entities.Entities.Lookup.Department", b =>
                {
                    b.Navigation("DepartmentDevices");
                });
