...
namespace BackendCore.Data.Migrations
{
    ...
    [Migration("20220412012645_AddPaymentTypeRelation")]
    partial class AddPaymentTypeRelation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackendCore.Entities.Entities.Business.CartItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BackendCore.Entities.Entities.Business.Currency", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BackendCore.Entities.Entities.Business.DamageItemDeatil", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BackendCore.Entities.Entities.Business.Item", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BackendCore.Entities.Entities.Business.ItemsHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BackendCore.Entities.Entities.Business.Supplier", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BackendCore.Entities.Entities.Business.TransactionModeHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TransactionModeHistories");
                });
            ...
            modelBuilder.Entity("BackendCore.Entities.Entities.Identity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NameAr = "مدير",
                            NameEn = "Admin",
                            Password = "AJG69oh+u6stsgQQjfIH++GpMTv6Acz7uALYljP1caIp/pmF0QBUwMUVxwkpxEzBDA==",
                            Phone = "01016670280",
                            RoleId = 1L,
                            UserName = "admin"
                        });
            ...
            modelBuilder.Entity("BackendCore.Entities.Entities.Business.CartItem", b =>
                {
                    ...
                    b.HasOne("BackendCore.Entities.Entities.Business.Item", "Item")
                        .WithMany()
            ...
            modelBuilder.Entity("BackendCore.Entities.Entities.Business.Item", b =>
                {
                    ...
                    b.HasOne("BackendCore.Entities.Entities.Business.Supplier", "Supplier")
                        .WithMany()
            ...
            modelBuilder.Entity("BackendCore.Entities.Entities.Business.Transaction", b =>
                {
                    b.HasOne("BackendCore.Entities.Entities.Business.Currency", "Currency")
                        .WithMany()
            ...
            modelBuilder.Entity("BackendCore.Entities.Entities.Business.TransactionModeHistory", b =>
                {
                    b.HasOne("BackendCore.Entities.Entities.Business.Transaction", "Transaction")
                        .WithMany("TransactionModeHistories")
                        .HasForeignKey("TransactionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BackendCore.Entities.Entities.Business.Item", b =>
                {
                    b.Navigation("DamageItemDeatils");

                    b.Navigation("ItemsHistories");
            ...
            modelBuilder.Entity("BackendCore.Entities.Entities.Business.Transaction", b =>
                {
                    ...
                    b.Navigation("TransactionModeHistories");
                });
