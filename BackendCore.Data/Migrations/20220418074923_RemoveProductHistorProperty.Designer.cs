...
namespace BackendCore.Data.Migrations
{
    ...
    [Migration("20220418074923_RemoveProductHistorProperty")]
    partial class RemoveProductHistorProperty
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackendCore.Entities.Entities.Business.DamageProductDeatil", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("TotalDamageProduc")
                        .HasColumnType("int");
                    ...
                    b.ToTable("DamageProductDeatils");
                });
            ...
            modelBuilder.Entity("BackendCore.Entities.Entities.Identity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NameAr = "مدير",
                            NameEn = "Admin",
                            Password = "ANSCiGxgNi7LSLIUVz3NmUtntOZYSOtoDeMt5Zq6e5BX5ydBH1N+JYdCqOKd/b9gXg==",
                            Phone = "01016670280",
                            RoleId = 1L,
                            UserName = "admin"
                        });
            ...
            modelBuilder.Entity("BackendCore.Entities.Entities.Business.DamageProductDeatil", b =>
                {
                    b.HasOne("BackendCore.Entities.Entities.Business.Product", "Produc")
                        .WithMany("DamageProducDeatils")
            ...
            modelBuilder.Entity("BackendCore.Entities.Entities.Business.ProductsHistory", b =>
                {
                    b.HasOne("BackendCore.Entities.Entities.Business.Product", null)
                        .WithMany("ProducsHistories")
                        .HasForeignKey("ProductId");
                });
            ...
            modelBuilder.Entity("BackendCore.Entities.Entities.Business.Product", b =>
                {
                    b.Navigation("DamageProducDeatils");

                    b.Navigation("ProducsHistories");
